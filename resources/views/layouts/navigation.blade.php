        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    <div class="flex items-center">
                        ...
                        <a
                            ...
                            class="relative inline-flex items-center justify-center p-2 text-gray-500 hover:text-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 mr-2"
                            aria-label="通知"
                        >
                            <svg
                            ...
                            @if($unreadNotificationCount > 0)
                                <span
                                    class="absolute top-0 right-0 min-w-[16px] h-4 px-1
                ...
                @else
                    ...
                    <a
                        href="{{ route('register') }}"
                        class="ml-4 text-sm text-gray-700 underline hover:text-gray-900"
                    >
                        新規登録
                    </a>
                @endauth
            ...
            @auth
                ...
                <div class="mt-3 space-y-1">
                    ...
                    >
                        ...
                        @if($unreadNotificationCount > 0)
                            <span class="ml-2 text-xs text-red-500 font-bold">
